...
def generate_variance_block(
    ...
    Format pools are provided by the subject strategy, ensuring that only
    subject- and difficulty-appropriate formats are selected.

    Args:
        strategy: The resolved SubjectStrategy providing format pools.
    ...
    for level in unique_levels:
        pool = strategy.get_format_pool(level)

...
class GardenSubjectCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Isolate each card (incl. its plant SVG) so one card's repaint doesn't
    // invalidate sibling cards in the horizontally-scrolling garden row.
    return RepaintBoundary(
      child: GestureDetector(
        onTap: onTap,
        // opaque so taps on the card's transparent gaps (Column spacers, the
        // area below the bottom-aligned content) still register — without this
        // the default deferToChild drops taps that miss a painted child.
